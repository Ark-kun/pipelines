...
from kfp.components._structures import ComponentReference, ComponentSpec, ContainerSpec, GraphInputArgument, GraphSpec, InputSpec, InputValuePlaceholder, ImplementationSpec, OutputPathPlaceholder, OutputSpec, TaskOutputArgument, TaskSpec
...
class GraphComponentTestCase(unittest.TestCase):
    def test_handle_constructing_graph_component(self):
        ...
        graph_component1 = ComponentSpec(
            ...
            implementation=ImplementationSpec(graph=GraphSpec(
                tasks={
                    'task 1': task1,
                    'task 2': task2,
                    'task 3': task3,
...
#test task name conversion to Argo-compatible names
