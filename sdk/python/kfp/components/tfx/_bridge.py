...
from google3.third_party.tfx.components.base.base_component import BaseComponent
from google3.third_party.tfx.components.base.executor_spec import ExecutorContainerSpec
from google3.third_party.tfx.types import component_spec as tfx_component_spec
from google3.third_party.tfx.types.artifact import Artifact
from google3.third_party.tfx.types.channel import Channel
from google3.third_party.tfx.types.component_spec import ChannelParameter
from google3.third_party.tfx.types.standard_artifacts import ANY_ARTIFACT_TYPE_NAME


def _create_artifact_type(type_struct) -> metadata_store_pb2.ArtifactType:
  """Creates ArtifactType instance based on type_struct.
  Args:
    type_struct: The name of the artifact type. Default value is "Any",
  """
...
class InputArtifactUri(object):
  ...
  def __init__(self, data_type: Type[Any] = None, type_struct: str = None):
    if data_type and type_struct:
      raise ValueError('Cannot specify data_type and type_struct at the same time')
    if type_struct:
...
class OutputArtifactUri(object):
...
class ExecutionProperty(object):
